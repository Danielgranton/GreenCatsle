...
export default function AdminComplaintsPage() {
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      ...
      const resp = await fetch(`${API_BASE}/business?${qs.toString()}`, {
    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Handle customer issues for your business.</p>
        </div>
        <button
          type="button"
          onClick={load}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
          <div>
            ...
            <input
              ...
              placeholder="Order ID, message, customer…"
                ...
                filtered.map((c) => (
                  <tr key={c._id} className="align-top">
                    ...
                    <td className="px-4 py-4 text-gray-700">
                      <div className="max-w-[260px] truncate" title={userText(c.userId)}>
                        {userText(c.userId)}
                      </div>
                    </td>
                    <td className="px-4 py-4 text-gray-700">
                    ...
                    <td className="px-4 py-4 text-gray-600">
                      <div className="max-w-[220px] truncate" title={idText(c.orderId)}>
                        {idText(c.orderId)}
                      </div>
                    </td>
